...
class PluginOpenmedisMedicalConsumableItem extends CommonDBTM {
   ...
   static $rightname                   = 'plugin_openmedis_consumable';
   ...
   **/
   ...
   /**
    * Add a compatible printer type for a medical consumable type
    *
   ...
   **/
   function addCompatibleType($medicalconsumableitems_id, $printermodels_id) {
      global $DB;
      ...
      if (($medicalconsumableitems_id > 0)
         ...
         $params = [
            ...
            'plugin_openmedis_medicaldevicemodels_id'  => $printermodels_id
         ];
   ...
   **/
   static function dropdownForMedicalDevice(Printer $printer) {
      global $DB;
      ...
      $iterator = $DB->request([
         ...
         'WHERE'        => [
            'glpi_plugin_openmedis_medicalconsumableitems_medicaldevicemodels.plugin_openmedis_medicaldevicemodels_id'  => $printer->fields['plugin_openmedis_medicaldevicemodels_id']
         ] + getEntitiesRestrictCriteria('glpi_plugin_openmedis_medicalconsumableitems', '', $printer->fields['entities_id'], true),
         'GROUPBY'      => 'tID',
         'ORDERBY'      => ['name', 'ref']
      ]);
