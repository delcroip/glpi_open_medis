 ...
 * This class is used to manage printer medicalconsumables.
...
class PluginOpenmedisMedicalConsumable extends CommonDBChild {
   ...
   /**
    * Link a medicalconsumable to a printer.
    *
    * Link the first unused medicalconsumable of type $Tid to the printer $pID.
    *
   ...
   **/
   ...
   /**
    * Unlink a medicalconsumable from a printer by medicalconsumable ID.
    *
   ...
   **/
   ...
   /**
    * Print the medicalconsumable count HTML array for the printer $pID
    *
    * @since 0.85
    *
    * @param integer         $pID    ID of the printer
   ...
   **/
   ...
   /**
    * Count the number of medicalconsumables used for the printer $pID
    *
    * @since 0.85
    *
    * @param integer $pID ID of the printer.
   ...
   **/
   ...
   /**
    * Count the number of used medicalconsumables used for the printer $pID.
    *
    * @since 0.85
    *
    * @param integer $pID ID of the printer.
   ...
   **/
   ...
   /**
    * count how many old medical consumable for theprinter $pID
    *
    * @since 0.85
    *
   ...
   **/
   static function showForMedicalDevice(PluginOpenmedisMedicalDevice $medicaldevice, $old = 0) {
      ...
      $canedit = Session::haveRight("plugin_openmedis_consumable", UPDATE);
      $rand    = mt_rand();
    ...
    *     - parent Object : the printers where the medical consumable is used
    *
   ...
   /**
    * Count the number of medical consumables associated with the given printer.
